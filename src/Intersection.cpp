...
void Intersection::addVehicleToQueue(std::shared_ptr<Vehicle> vehicle)
{
    ...
    lck.lock();
  	...
  	//std::string light = (_trafficLight.getCurrentPhase() == TrafficLightPhase::red)? "red" : "green";
  	//std::cout << "Intersection #" << _id << " traffic light is: " << light << std::endl;
  	//use TrafficLight::waitForGreen to block the execution until the traffic light turns green.
